...
class UserDetailActivity : AppCompatActivity(), OnMapReadyCallback, UserDetailContract.View {
    ...
    override fun setUserData(item: UserData.Result?) {
        binding.userdata = item
        binding.executePendingBindings()
    }

    override fun setViewIntentClickListener(item: UserData.Result?) {
